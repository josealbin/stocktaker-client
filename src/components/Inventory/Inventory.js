...
import { faClone, faFilePdf, faSort, faMagnifyingGlass } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <div>
            ...
            <div className="upload_file">
                <input type="file" className='upload_box' onChange={handleFileUpload} required />
                <button className="upload-btn" onClick={updateTableWithFileData}><FontAwesomeIcon icon={faClone} className='icon' /> Update</button>
