...
function Controls() {
  ...
  return (
    <div className='control-pane'>
      <nav className="nav">
        <Link to='/dashboard'><FontAwesomeIcon icon={faChartSimple} className='icon' /> Dashboard</Link>
        <Link to='/inventory'><FontAwesomeIcon icon={faCubes} className='icon' /> Inventory</Link>
        <Link to='/customers'><FontAwesomeIcon icon={faUsers} className='icon' /> Customers</Link>
